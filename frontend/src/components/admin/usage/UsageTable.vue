      ...
      >
        ...
        <template #cell-cost="{ row }">
          <div class="text-sm">
            ...
            <div v-if="row.account_rate_multiplier != null && !authStore.hidesBillingUi" class="mt-0.5 text-[11px] text-orange-500 dark:text-orange-400">
    ...
    >
      <div class="whitespace-nowrap rounded-lg border border-gray-700 bg-gray-900 px-3 py-2.5 text-xs text-white shadow-xl dark:border-gray-600 dark:bg-gray-800">
        <div class="space-y-1.5">
          ...
          <div v-if="!authStore.hidesBillingUi" class="flex items-center justify-between gap-6">
          ...
          <div v-if="!authStore.hidesBillingUi" class="flex items-center justify-between gap-6 border-t border-gray-700 pt-1.5">
