export default {
  ...
  auth: {
    ...
    loginKeyPlaceholder: 'Enter login key',
    loginKeyRequired: 'Login key is required',
  ...
  admin: {
    ...
    users: {
      ...
      loginKey: 'Login Key',
      loginKeySet: 'Set',
      loginKeyNotSet: 'Not set',
      loginKeyUnavailable: 'Plaintext not saved',
      setLoginKey: 'Set Login Key',
      resetLoginKey: 'Reset Login Key',
      clearLoginKey: 'Clear Login Key',
      loginKeySetSuccess: 'Login key set',
      loginKeyResetSuccess: 'Login key reset. Save the new key now.',
      loginKeyClearSuccess: 'Login key cleared',
      loginKeyActionFailed: 'Login key action failed',
      loginKeyDialogTitle: 'Set Login Key',
      loginKeyDialogHint: 'This replaces the homepage login key for the user. Admins can view and copy it from the user list.',
      loginKeyInputPlaceholder: 'Enter new login key',
      loginKeyRequired: 'Enter a login key',
      copyLoginKey: 'Copy login key',
      loginKeyOneTimeTitle: 'New Login Key',
      loginKeyOneTimeHint: 'This key is shown only once. Save it and share it with the user now.',
    ...
    accounts: {
      ...
      groupPriority: {
        ...
        currentPageHint: '{count} account(s) on this page can be adjusted. Lower values are used first. This only affects the current group and does not change global priority.',
      ...
      priority: 'Global Priority',
      priorityHint: 'Default/fallback priority. Lower values are used first. Group scheduling uses the group priority when one is set.',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        personalDescription: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Sub2API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>📊 <b>Usage Tracking</b> - Keep request and token statistics visible</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
