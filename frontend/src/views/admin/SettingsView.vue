...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Noreply1018/sub2api/blob/local-custom/docs/upstream/docs/PAYMENT_CN.md"
    : "https://github.com/Noreply1018/sub2api/blob/local-custom/docs/upstream/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Noreply1018/sub2api/blob/local-custom/docs/upstream/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/Noreply1018/sub2api/blob/local-custom/docs/upstream/docs/PAYMENT.md#supported-payment-methods",
);
