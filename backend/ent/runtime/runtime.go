...
func init() {
	...
	// userDescLoginKeyHash is the schema descriptor for login_key_hash field.
	userDescLoginKeyHash := userFields[2].Descriptor()
	// user.LoginKeyHashValidator is a validator for the "login_key_hash" field. It is called by the builders before save.
	user.LoginKeyHashValidator = userDescLoginKeyHash.Validators[0].(func(string) error)
