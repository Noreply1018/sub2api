...
var (
	...
	ErrLoginKeyRequired         = infraerrors.BadRequest("LOGIN_KEY_REQUIRED", "login key is required")
	ErrLoginKeyExists           = infraerrors.Conflict("LOGIN_KEY_EXISTS", "login key is already used by another user")
