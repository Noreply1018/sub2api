...
func (s *userRepoStubForGroupUpdate) GetByLoginKeyHash(context.Context, string) (*User, error) {
	panic("unexpected")
}
...
func (s *userRepoStubForGroupUpdate) UpdateLoginKeyHash(context.Context, int64, *string) error {
	panic("unexpected")
}
